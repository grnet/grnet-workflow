...
scope.ArrayUtil = {
		...
		groupByProperty: function (array, property) {
			...
			array.forEach( function( o ) {
				var group = (o[property] || "_empty_").toString();
		...
		mapByProperty2Property: function (array, property, innerProperty) {
			var groups = {};
			array.forEach( function( o ) {
				var key = (o[property] || "_empty_").toString();
		...
		mapByProperty2innerProperty: function (array, property, innerProperty, name) {
			var groups = {};
			array.forEach( function( o ) {
				var key = (o[property][innerProperty] || "_empty_").toString();
				groups[key] = groups[key] || {};
