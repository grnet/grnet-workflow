define(['angular'],
	...
	function (angular) {
		...
		angular.module('wfManagerDirectives').directive('wfDocumentInput', ['$mdDialog', documentInput]);

		angular.module('wfManagerControllers').controller('addFileController', ['$scope', '$mdDialog', 'wfDocument', 'wfCallback', documentInputCtrl]);
	}
);