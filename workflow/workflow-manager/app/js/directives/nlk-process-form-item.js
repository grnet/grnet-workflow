(function (angular) {
    ...
    angular.module('wfDirectives').directive('nlkProcessFormItem', ['$compile', '$mdToast',
		/**
		 * @name nlkProcessFormItem
		 * @ngDoc directives
		 * @memberof wfDirectives
		 * @desc Directive used to render the user's form
		 */
        function ($compile, $mdToast) {

            /**
             * @memberOf nlkProcessFormItem
            ...
            function itemTemplate(type) {
                ...
                switch (type) {
                    ...
                    case 'document':
						inputTmpl =
							'<section layout="row" class="md-block">' +
							'<wf-document-input id="{{ngModel.id}}" wf-variable-code="{{ngModel.id}}" style="width:100%" ' +
                    ...
                    case 'textarea':
						inputTmpl =
							...
							'<label for="{{ngModel.id}}" ng-class=" !ngModel.writable || wfPreview() ? \'\' : \'md-primary\' ">{{ngModel.name}}</label>' +
                    ...
                    case 'date':
						inputTmpl =
							...
							'<label class="wf-label" ng-class=" !ngModel.writable || wfPreview() ? \'disabledLabel\' : \'md-primary\' ">{{ ngModel.name }}</label> ' +
