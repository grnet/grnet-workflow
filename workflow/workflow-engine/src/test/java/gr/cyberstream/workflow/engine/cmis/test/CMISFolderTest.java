...
public class CMISFolderTest {
	
	final static Logger logger = LoggerFactory.getLogger(CMISFolderTest.class);
	...
	@Test
	public void shouldCreateInstanceFolder() {
		
		Folder folder = FileUtils.getFolder("/Famous One Task Process", cmisSession.getSession());
		
		//Folder newFolder = FileUtils.createFolder(folder, "Test Folder", BaseTypeId.CMIS_FOLDER.value());
		
		Folder newFolder = cmisFolder.createInstanceFolder(folder, "Test Folder");
