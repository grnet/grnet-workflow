...
public class PublicFormControllerTest {
	...
	public void getPublicServices() throws Exception {
		...
		List<WfPublicService> publicServices = Arrays.asList(new WfPublicService[]{
				new WfPublicService()
		});
	...
	public void getPublicForm() throws Exception {
		...
		when(processService.getPublicProcessMetadata(any(String.class))).thenReturn(processMetadata);
		
		ResultActions resultActions = mockMvc.perform(get("/api/v2/public/form/{id}", id).accept(MediaType.APPLICATION_JSON))
				.andExpect(status().isOk());
	...
	public void getProcessPublicForms() throws Exception {
		...
		List<WfPublicForm> publicForms = Arrays.asList(new WfPublicForm[]{
				new WfPublicForm()
		});
		
		when(processService.getProcessExternalForms(any(Integer.class))).thenReturn(publicForms);
		
		ResultActions resultActions = mockMvc.perform(get("/api/v2/form/process/{id}", id).accept(MediaType.APPLICATION_JSON))
				.andExpect(status().isOk());
	...
	public void createPublicForm() throws Exception {
		...
		when(processService.createExternalForm(any(WfPublicForm.class))).thenReturn(form);
		
		ResultActions resultActions = mockMvc.perform(post("/api/v2/form")
	...
	public void updatePublicForm() throws Exception {
		...
		ResultActions resultActions = mockMvc.perform(put("/api/v2/form")
				.content("{}").contentType(MediaType.APPLICATION_JSON))
				.andExpect(status().isOk());
	...
	public void deletePublicForm() throws Exception {
		...
		mockMvc.perform(delete("/api/v2/form/{id}", id)
	...
	public void getExternalForms() throws Exception {
		...
		List<WfPublicForm> externalForms = Arrays.asList(new WfPublicForm[]{
				new WfPublicForm()
		});
		
		when(processService.getProcessExternalForms(any(Integer.class))).thenReturn(externalForms);
		
		ResultActions resultActions = mockMvc.perform(get("/api/v2/form/process/{id}", 1).accept(MediaType.APPLICATION_JSON))
				.andExpect(status().isOk());
	...
	public void getWrappedGroupsForms() throws Exception {
		...
		List<ExternalWrapper> externalForms = Arrays.asList(new ExternalWrapper[]{
				new ExternalWrapper()
		});
		
		when(processService.getExternalWrapper()).thenReturn(externalForms);
		
		ResultActions resultActions = mockMvc.perform(get("/api/v2/form/group/wrapped")
				.accept(MediaType.APPLICATION_JSON))
				.andExpect(status().isOk());
	...
	public void getPublicGroups() throws Exception {
		...
		List<WfPublicGroup> groups = Arrays.asList(new WfPublicGroup[]{
				new WfPublicGroup()
		});
		
		when(processService.getExternalGroups()).thenReturn(groups);
		
		ResultActions resultActions = mockMvc.perform(get("/api/v2/form/group")
				.accept(MediaType.APPLICATION_JSON))
				.andExpect(status().isOk());
	...
	public void createPublicGroup() throws Exception {
		...
		mockMvc.perform(post("/api/v2/form/group")
				.content("{}").contentType(MediaType.APPLICATION_JSON))
				.andExpect(status().isOk());
	}
	...
	public void getRegistries() throws Exception {
		...
		List<Registry> registries = Arrays.asList(new Registry[]{
				new Registry()
		});
	...
	public void createRegistry() throws Exception {
		...
		mockMvc.perform(post("/api/v2/registry")
				.content("{}").contentType(MediaType.APPLICATION_JSON))
				.andExpect(status().isOk());
	}
	...
	public void updateRegistry() throws Exception {
		...
		mockMvc.perform(put("/api/v2/registry")
				.content("{}").contentType(MediaType.APPLICATION_JSON))
				.andExpect(status().isOk());
	}
	...
	public void deleteRegistry() throws Exception {
		...
		mockMvc.perform(delete("/api/v2/registry/{id}", id)
				.accept(MediaType.APPLICATION_JSON))
				.andExpect(status().isOk());
	}
