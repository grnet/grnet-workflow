...
public class TaskControllerTest {
	...
	public void getTaskDetailsByDefinition() throws Exception {
		...
		int id = 1;
		List<WfTaskDetails> taskDetails = Arrays.asList(new WfTaskDetails[]{
				new WfTaskDetails()
		});
		
		when(processService.getVersionTaskDetails(any(Integer.class))).thenReturn(taskDetails);
		
		ResultActions resultActions = mockMvc.perform(get("/api/v2/task/process/version/{id}", id).accept(MediaType.APPLICATION_JSON))
	...
	public void getTaskCandidates() throws Exception {
		...
		String id = "task";
		List<WfUser> users = Arrays.asList(new WfUser[]{
				new WfUser()
		});
		
		when(processService.getCandidatesByTaskId(any(String.class))).thenReturn(users);
		
		ResultActions resultActions = mockMvc.perform(get("/api/v2/task/{id}/candidates", id).accept(MediaType.APPLICATION_JSON))
				.andExpect(status().isOk());
	...
	public void getTasksByExecutionId() throws Exception {
		...
		String id = "execution";
		List<WfTask> tasks = Arrays.asList(new WfTask[]{
				new WfTask()
		});
		
		when(processService.getTasksByInstanceId(any(String.class))).thenReturn(tasks);
		
		ResultActions resultActions = mockMvc.perform(get("/api/v2/task/execution/{id}", id).accept(MediaType.APPLICATION_JSON))
				.andExpect(status().isOk());
	...
	public void filterUserCompletedTasks() throws Exception {
		...
		ResultActions resultActions = mockMvc
				.perform(get("/api/v2/tasks/completed/user;instance=1,2")
	...
	public void filterAllCompletedTasks() throws Exception {
		...
		ResultActions resultActions = mockMvc
				.perform(get("/api/v2/tasks/completed/all;instance=1,2")
				.accept(MediaType.APPLICATION_JSON))
				.andExpect(status().isOk());
	...
	public void searchEndedExecutionTasks() throws Exception {
		...
		when(processService.getEndedProcessInstancesTasks(any(String.class), any(Long.class),
				any(Long.class), any(Boolean.class))).thenReturn(tasks);
		
		ResultActions resultActions = mockMvc.perform(
				get("/api/v2/task/execution/ended/search:{title},{after},{before},{anonymous}",
						title, after, before, anonymous).accept(MediaType.APPLICATION_JSON))
				.andExpect(status().isOk());
	...
	public void searchUserTasks() throws Exception {
		...
		when(processService.getUserActivity(any(Long.class),
				any(Long.class), any(String.class))).thenReturn(tasks);
		
		ResultActions resultActions = mockMvc.perform(
				get("/api/v2/task/search:{after},{before}/assignee/{userId}",
						after, before, userId).accept(MediaType.APPLICATION_JSON))
				.andExpect(status().isOk());
	...
	public void getTask() throws Exception {
		...
		ResultActions resultActions = mockMvc.perform(get("/api/v2/task/{id}", id)
				.accept(MediaType.APPLICATION_JSON))
				.andExpect(status().isOk());
	...
	public void updateTask() throws Exception {
		...
		mockMvc.perform(put("/api/v2/task")
	...
	public void claimTask() throws Exception {
		...
		mockMvc.perform(put("/api/v2/task/{id}/claim", id)
				.accept(MediaType.APPLICATION_JSON))
				.andExpect(status().isOk());
	}
	...
	public void removeTask() throws Exception {
		...
		mockMvc.perform(put("/api/v2/task/{id}/unclaim", id)
				.accept(MediaType.APPLICATION_JSON))
				.andExpect(status().isOk());
	}
	...
	public void assignTask() throws Exception {
		...
		mockMvc.perform(post("/api/v2/task/assign/{assignee}", assignee)
				.content("{}").contentType(MediaType.APPLICATION_JSON))
				.andExpect(status().isOk());
	}
	...
	public void assignTaskWithFiles() throws Exception {
		...
		mockMvc.perform(fileUpload("/api/v2/task/assign/{assignee}", assignee)
				.file(data).file(file).contentType(MediaType.MULTIPART_FORM_DATA))
				.andExpect(status().isOk());
	}
	...
	public void saveTask() throws Exception {
		...
		mockMvc.perform(post("/api/v2/task/save")
				.content("{}").contentType(MediaType.APPLICATION_JSON))
				.andExpect(status().isOk());
	}
	...
	public void saveTaskWithFiles() throws Exception {
		...
		mockMvc.perform(fileUpload("/api/v2/task/save")
				.file(data).file(file).contentType(MediaType.MULTIPART_FORM_DATA))
				.andExpect(status().isOk());
	}
	...
	public void completeTask() throws Exception {
		...
		mockMvc.perform(post("/api/v2/task/complete")
				.content("{}").contentType(MediaType.APPLICATION_JSON))
				.andExpect(status().isOk());
	}
	...
	public void completeTaskWithFiles() throws Exception {
		...
		mockMvc.perform(fileUpload("/api/v2/task/complete")
				.file(data).file(file).contentType(MediaType.MULTIPART_FORM_DATA))
				.andExpect(status().isOk());
	}
	...
	public void getTaskForm() throws Exception {
		...
		List<WfFormProperty> form = Arrays.asList(new WfFormProperty[]{
				new WfFormProperty()
		});
		
		when(processService.getTaskFormPropertiesByTaskDefintionKey(any(String.class), any(String.class))).thenReturn(form);
		
		ResultActions resultActions = mockMvc.perform(get("/api/v2/task/definition/{taskDefinitionKey}/process/{processDefinitionId}",
	...
	public void getDocumentsByTask() throws Exception {
		...
		int id = 1;
		List<WfDocument> documents = Arrays.asList(new WfDocument[]{
				new WfDocument()
		});
		
		when(processService.getProcessInstanceDocumentsByTask(any(Integer.class))).thenReturn(documents);
		
		ResultActions resultActions = mockMvc.perform(get("/api/v2/task/{id}/document", id).accept(MediaType.APPLICATION_JSON))
				.andExpect(status().isOk());
