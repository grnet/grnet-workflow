...
*/
@RestController("publicFormV2Controller")
...
public class PublicFormController {
	 ...
	 * specfied public form id and device
	 * 
	 * @param id
	 * @param device
	 * @return
	...
	@ResponseBody
	public List<WfPublicForm> getProcessPublicForms(@PathVariable int id) throws InvalidRequestException {
		
		List<WfPublicForm> wfForms = processService.getExternalFromsByDefinitionId(id);
	...
	public WfPublicForm createPublicForm(@RequestBody WfPublicForm form) throws InvalidRequestException {
		...
		return processService.createPublicForm(form);
	}
	...
	public WfPublicForm modifyExternalFormStatus(@PathVariable String id, @PathVariable String action) throws InvalidRequestException{
		...
		if(action.equals("suspend"))
			form = processService.modifyExternalFormStatus(id, false);
		else if(action.equals("resume"))
			form = processService.modifyExternalFormStatus(id, true);
	...
	@ResponseBody
	public List<WfRegistry> getRegistries() throws InvalidRequestException {
	...
	public void createRegistry(@RequestBody WfRegistry wfRegistry) throws InvalidRequestException{
	...
	@ResponseBody
	@PreAuthorize("hasRole('Admin')")
	public void updateRegistry(@RequestBody WfRegistry wfRegistry) throws InvalidRequestException{
	...
	@ResponseBody
	@PreAuthorize("hasRole('Admin')")
	public void deleteRegistry(@PathVariable String id) throws InvalidRequestException{
	...
	/**
	 * <code>DELETE: /api/v2/form/group/{groupId}</code>
	 * 
	 * Deletes a group
	 * 
	 * @param groupId
	...
	/**
	 * <code>PUT: /api/v2/form/group</code>
	 * 
	 * Updates a group
	 * 
	 * @param publicGroup
	...
	/**
	 * <code>GET: /api/v2/status</code>
	 * 
	 * A simple get to check if the server is running
	 * 
	 */
