...
public class ExecutionController {
	 ...
	 * 
	 * Returns all running instances for the specified process definition version.
	 * 
	 * @param id
	 * 
	 * @return
	...
	public WfProcessInstance startProcess(@PathVariable int id, @RequestBody WfProcessInstance instanceData) throws InvalidRequestException {
	 ...
	 * 
	 * @param processId the workflow definition id
	 * @param formData the form data in key-value pairs
	 * @throws InvalidRequestException
	 */
	@RequestMapping(value = "/process/{id}/start", method = RequestMethod.POST,
	...
	@RequestMapping(value = "/public/form/{id}/start", method = RequestMethod.POST, 
			consumes={MediaType.MULTIPART_FORM_DATA_VALUE})
	@ResponseBody
	public WfProcessInstance startPublicProcessWithDocuments(@PathVariable String id, @RequestPart("json") String instanceData,
	...
	@ResponseBody
	public WfProcessInstance startPublicMobileProcess(@PathVariable String id, @RequestBody WfProcessInstance instanceData)
			throws InvalidRequestException {
	...
	@RequestMapping(value = "/mobile/form/{id}/start", method = RequestMethod.POST,
			consumes = {MediaType.MULTIPART_FORM_DATA_VALUE})
	@ResponseBody
	public WfProcessInstance startPublicMobileProcessWithDocuments(@PathVariable String id, @RequestPart("json") String instanceData,
			@RequestParam("file") MultipartFile[] files)
			throws InvalidRequestException {
	 ...
	 * @return
	 */
	@RequestMapping(value = "/execution/{id}/diagram", method = RequestMethod.GET,
